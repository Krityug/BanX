...
import org.pyacademy.banlistener.BanUnit;
    ...
    public boolean onCommand(CommandSender sender, Command cmd, String desc, String[] args) {
        if(sender instanceof Player){
            ...
            if(cmd.getName().equalsIgnoreCase("tempban")){
                ...
                if(!player.isOp()){
                    player.sendMessage(ChatColor.RED + "[BanX] You don't have permission to do this.");
                    return true;
                }

                if(target==null || !target.isOnline()){
                    player.sendMessage(ChatColor.RED + "[BanX] Player could not be found!");
                    return true;
                }
                ...
                if(diff > 0){
                    ...
                    plugin.server.broadcastMessage(GOLD + "[BanX] " + GREEN + "The player " + AQUA + target.getName() + GREEN + " is now banned for " + AQUA  + message);
                    target.kickPlayer("[BanX] You are temp-banned for " + message);
                    return true;
                }else{
            ...
            if(cmd.getName().equalsIgnoreCase("tempbanexact")){
                ...
                if(diff > 0){
                    ...
                    plugin.server.broadcastMessage(GOLD + "[BanX] " + GREEN + "The player " + AQUA + args[0].toLowerCase() + GREEN + " is now banned for " + AQUA + message);
                    return true;
                }else{
                    player.sendMessage(ChatColor.RED + "Error: Unit or time not valid.");
                    return true;
            ...
            if(cmd.getName().equalsIgnoreCase("unban")){
                ...
                if(getBanned().containsKey(target.toLowerCase())){
                    ...
                    player.sendMessage(GOLD + "[BanX] " + GREEN + "The player " + AQUA + args[0] + GREEN + " is now un-banned.");
                    return true;
                }else{
            ...
            if(cmd.getName().equalsIgnoreCase("check")){
                ...
                if(getBanned().containsKey(target.toLowerCase())){
                    player.sendMessage(GOLD + "[BanX] " + GREEN + "The player " + AQUA + args[0] + GREEN + " is banned for " + AQUA + getMSG(getBanned().get(target.toLowerCase())));
                    return true;
                }else{
                    player.sendMessage(GOLD + "[BanX] " + GREEN + "The player " + AQUA + args[0] + GREEN + " is not banned.");
                    return true;
                }
            }
        }else{
            ...
            if(cmd.getName().equalsIgnoreCase("tempban")){
                ...
                if(target==null || !target.isOnline()){
                    System.out.println("[BanX] Player could not be found!");
                    return true;
                }
                ...
                if(diff > 0){
                    ...
                    plugin.server.broadcastMessage("[BanX] The player " + target.getName() + " is now banned for " + message);
                    target.kickPlayer("[BanX] You are temp-banned for " + message);
                    return true;
                }else{
            ...
            if(cmd.getName().equalsIgnoreCase("check")){
                ...
                if(getBanned().containsKey(target.toLowerCase())){
                    System.out.println("[BanX] The player " + args[0] + " is banned for " + getMSG(getBanned().get(args[0].toLowerCase())));
                    return true;
                }else{
                    System.out.println("[BanX] The player " + args[0] + " is not banned.");
                    return true;
                }
            }
        }
